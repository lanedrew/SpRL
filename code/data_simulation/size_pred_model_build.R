...
save(size.mod, file = './code/data_simulation/size_models/high_dens_size_mod.RData')
...
save(size.mod, file = './code/data_simulation/size_models/med_dens_size_mod.RData')
...
save(size.mod, file = './code/data_simulation/size_models/low_dens_size_mod.RData')
