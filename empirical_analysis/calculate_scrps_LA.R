...
la_results_file <- paste0("./code/empirical_data/emp_pooled_LA_N_25_model_", model_type, "_covars_", covars, "_growth_cutoff_", mort_threshold, "_index_", index, ".csv")
rep1_results_file <- paste0("./code/empirical_data/emp_pooled_LA_N_25_model_", model_type, "_covars_", covars, "_growth_cutoff_", mort_threshold, "_index_", index, "_rep1.csv")
rep2_results_file <- paste0("./code/empirical_data/emp_pooled_LA_N_25_model_", model_type, "_covars_", covars, "_growth_cutoff_", mort_threshold, "_index_", index, "_rep2.csv")


y_rep1 <- read_csv(file = rep1_results_file) %>% as.matrix()
y_rep2 <- read_csv(file = rep1_results_file) %>% as.matrix()

calc_scrps <- scrps(y_rep1, y_rep2, G[gc_index])

scrps_results_file <- paste0("./code/empirical_data/emp_pooled_LA_N_25_model_", model_type, "_covars_", covars, "_growth_cutoff_", mort_threshold, "_index_", index, "_scrps.RDS")
saveRDS(calc_scrps, scrps_results_file)
