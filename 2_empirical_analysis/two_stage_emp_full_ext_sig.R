...
# lambda_file <- paste0("./code/empirical_data/empirical_linkage_lambda_results_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
# s_file <- paste0("./code/empirical_data/empirical_linkage_s_results_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
# t_file <- paste0("./code/empirical_data/empirical_linkage_t_results_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
# sigma2_file <- paste0("./code/empirical_data/empirical_linkage_sigma2_results_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
lambda_file <- paste0("./code/empirical_data/empirical_linkage_lambda_results_N_25_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
s_file <- paste0("./code/empirical_data/empirical_linkage_s_results_N_25_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
t_file <- paste0("./code/empirical_data/empirical_linkage_t_results_N_25_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
sigma2_file <- paste0("./code/empirical_data/empirical_linkage_sigma2_results_N_25_sigma2_prior_", sigma2_prior, "_chain_", chain,".csv")
...
# res_rds <- paste0("./code/empirical_data/empirical_linkage_full_results_sigma2_prior_", sigma2_prior, "_chain_", chain,"_part2.rds")
res_rds <- paste0("./code/empirical_data/empirical_linkage_full_results_N_25_sigma2_prior_", sigma2_prior, "_chain_", chain,"_part2.rds")
