...
#   list.files(path = "./code/growth_sim_results/true_linkage",
#              pattern = "1_alpha",
#              full.names = TRUE) %>%
#   mixedsort() %>%
#   map_df(~read_plus(.))
...
# myNames <- gsub("./code/growth_sim_results/true_linkage/", "", sprl_growth_sim_table$filename, fixed = TRUE)
...
# ## Read in the data
# sprl_growth_sim_table <-
#   list.files(path = "./code/growth_sim_results/NDM/growth_model_ests",
#              pattern = "1_alpha",
#              full.names = TRUE) %>%
#   mixedsort() %>%
#   map_df(~read_plus(.))
...
# 
# ## Modify the names from the files
# myNames <- gsub("./code/growth_sim_results/NDM/growth_model_ests/", "", sprl_growth_sim_table$filename, fixed = TRUE)
...
# ## Read in the data
# sprl_growth_sim_table <-
#   list.files(path = "./code/growth_sim_results/two_stage/linkage_avg",
#              pattern = "1_alpha",
#              full.names = TRUE) %>%
#   mixedsort() %>%
#   map_df(~read_plus(.))
...
# 
# ## Modify the names from the files
# myNames <- gsub("./code/growth_sim_results/two_stage/linkage_avg/", "", sprl_growth_sim_table$filename, fixed = TRUE)
...
# 
# all_cov_table <- rbind(TL_cov_table, NDM_cov_table, LA_cov_table)
# 
# write_csv(as.data.frame(all_cov_table), file = "./code/growth_sim_results/all_sim_1_alpha_cov_table.csv")
# 
# 
# growth_cov_table <- read_csv("./code/growth_sim_results/all_sim_1_alpha_cov_table.csv", show_col_types = FALSE)
# 
# 
# growth_cov_table_mod <- growth_cov_table |> 
#   pivot_wider(names_from = c("linkage"),
...
#                             levels = c("beta_0", "beta_1", "beta_2", "beta_3", "beta_4")))
# 
# growth_cov_table_mod |>
#   arrange(density, noise, true_alpha, parameter) |>
#   select(-c(true_alpha)) |>
#   kbl(booktabs = TRUE, align = "lllccc", linesep = "", escape = FALSE, digits = 4,
#       col.names = c("Density", "Noise", "Parameter", "TL", "NDM", "LA")) |> 
#   kable_classic() |> 
...
test_table$coverage <- coverage_func(test_table$parameter, true_value = c(12, 2, .5, 3, .5, -.5, .5, -.5),
                                     lower_bound = test_table$q5, upper_bound = test_table$q95)
...
write_csv(as.data.frame(all_cov_table), file = "./code/growth_sim_results/all_sim_2_alpha_cov_table.csv")
...
test_table$coverage <- coverage_func(test_table$parameter, true_value = c(12, 3, .5, 3, .5, -.5, .5, -.5),
                                     lower_bound = test_table$q5, upper_bound = test_table$q95)
...
write_csv(as.data.frame(all_cov_table), file = "./code/growth_sim_results/all_sim_3_alpha_cov_table.csv")
