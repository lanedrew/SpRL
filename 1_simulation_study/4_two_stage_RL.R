#####################################################################################
#### This script runs the record linkage model on a specified simulated dataset. ####
#####################################################################################
...
## Set the priors and relevant indices
...
## Specify the hyperparameters and initial values for the model
...
## Remove burn-in samples, process the linkage, and save results
burn_in <- 1:2501
...
write_csv(as.data.frame(linkage_res),
          paste0("./1_simulation_study/simulation_results/two_stage/linkage_processed/",
