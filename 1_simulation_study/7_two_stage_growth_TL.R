##########################################################################################
#### This script runs the growth model using the true linkage on a simulated dataset. ####
#########################################################################################
...
stanfit_true_linkage <- stan(file = "./resources/code/STAN_code/STAN_growth_mod_alpha.stan", # Stan file
